...
#include "GridPositionBasedInterpreterComponent.generated.h"
...
class UNREALGRIDMECHANICS_API UGridPositionBasedInterpreterComponent : public UActorComponent
{
	GENERATED_BODY()
...
#pragma region Calculations
	...
	virtual void CalculateGridAttacks(TArray<FGridPair>& OutGridPairs, AGridUnitBase* GridUnit, const TArray<FGridMovement>& InGridMovements);
